...
const file_wabenet_dodo_configuration_v1alpha2_configuration_proto_rawDesc = "" +
	"\n" +
	"7wabenet/dodo/configuration/v1alpha2/configuration.proto\x12#wabenet.dodo.configuration.v1alpha2\x1a\x1bgoogle/protobuf/empty.proto\x1a'wabenet/dodo/build/v1alpha2/build.proto\x1a+wabenet/dodo/runtime/v1alpha2/runtime.proto\"d\n" +
	...
	"\bcontents\x18\x02 \x01(\tR\bcontents2\xfd\x01\n" +
	"\x13ConfigurationPlugin\x12c\n" +
...
var file_wabenet_dodo_configuration_v1alpha2_configuration_proto_depIdxs = []int32{
	...
	4, // 4: wabenet.dodo.configuration.v1alpha2.Backdrop.required_files:type_name -> wabenet.dodo.configuration.v1alpha2.File
	7, // 5: wabenet.dodo.configuration.v1alpha2.ConfigurationPlugin.ListBackdrops:input_type -> google.protobuf.Empty
	1, // 6: wabenet.dodo.configuration.v1alpha2.ConfigurationPlugin.GetBackdrop:input_type -> wabenet.dodo.configuration.v1alpha2.GetBackdropRequest
	0, // 7: wabenet.dodo.configuration.v1alpha2.ConfigurationPlugin.ListBackdrops:output_type -> wabenet.dodo.configuration.v1alpha2.ListBackdropsResponse
	2, // 8: wabenet.dodo.configuration.v1alpha2.ConfigurationPlugin.GetBackdrop:output_type -> wabenet.dodo.configuration.v1alpha2.GetBackdropResponse

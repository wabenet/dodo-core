...
type StreamContainerResponse struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ExitCode    int64                  `protobuf:"varint,1,opt,name=exit_code,json=exitCode"`
...
func (x *ListVolumesResponse) GetNames() []string {
	if x != nil {
...
func (x *ListVolumesResponse) SetNames(v []string) {
...
type TerminalConfig struct {
	...
	xxx_hidden_ConsoleHeight int64                  `protobuf:"varint,3,opt,name=console_height,json=consoleHeight"`
	xxx_hidden_ConsoleWidth  int64                  `protobuf:"varint,4,opt,name=console_width,json=consoleWidth"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
func (x case_Mount_Type) String() string {
	md := file_wabenet_dodo_runtime_v1alpha2_runtime_proto_msgTypes[19].Descriptor()
	if x == 0 {
		return "not set"
	}
...
const file_wabenet_dodo_runtime_v1alpha2_runtime_proto_rawDesc = "" +
	...
	"\fcontainer_id\x18\x01 \x01(\tR\vcontainerId\x12\x16\n" +
	"\x06signal\x18\x02 \x01(\tR\x06signal\"P\n" +
	"\x17StreamContainerResponse\x12\x1b\n" +
	"\texit_code\x18\x01 \x01(\x03R\bexitCode\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\"+\n" +
	"\x13ListVolumesResponse\x12\x14\n" +
	...
	"\rKillContainer\x123.wabenet.dodo.runtime.v1alpha2.KillContainerRequest\x1a\x16.google.protobuf.Empty\x12Y\n" +
	"\vListVolumes\x12\x16.google.protobuf.Empty\x1a2.wabenet.dodo.runtime.v1alpha2.ListVolumesResponse\x12Z\n" +
...
func file_wabenet_dodo_runtime_v1alpha2_runtime_proto_init() {
	...
	file_wabenet_dodo_runtime_v1alpha2_runtime_proto_msgTypes[19].OneofWrappers = []any{
		(*mount_Bind)(nil),
		(*mount_Volume)(nil),
		(*mount_Tmpfs)(nil),
		(*mount_Image)(nil),

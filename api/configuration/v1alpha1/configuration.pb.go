...
type ListBackdropsResponse struct {
	...
	Backdrops []*v1alpha6.Backdrop `protobuf:"bytes,1,rep,name=backdrops,proto3" json:"backdrops,omitempty"`
}
...
func (x *ListBackdropsResponse) GetBackdrops() []*v1alpha6.Backdrop {
	if x != nil {
		return x.Backdrops
	}
	return nil
...
var file_configuration_v1alpha1_configuration_proto_rawDesc = []byte{
	...
	0x36, 0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1c,
	0x63, 0x6f, 0x72, 0x65, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x36, 0x2f, 0x62, 0x61,
	...
	0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x36, 0x2e, 0x42, 0x61, 0x63, 0x6b, 0x64, 0x72,
	...
	0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x36, 0x2e, 0x50,
	...
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x36, 0x2e, 0x42, 0x61, 0x63, 0x6b, 0x64, 0x72, 0x6f,
...
var file_configuration_v1alpha1_configuration_proto_goTypes = []interface{}{
	...
	(*v1alpha6.Backdrop)(nil),           // 2: com.wabenet.dodo.core.v1alpha6.Backdrop
	(*emptypb.Empty)(nil),               // 3: google.protobuf.Empty
	(*v1alpha6.PluginInfo)(nil),         // 4: com.wabenet.dodo.core.v1alpha6.PluginInfo
	(*v1alpha6.InitPluginResponse)(nil), // 5: com.wabenet.dodo.core.v1alpha6.InitPluginResponse
}
var file_configuration_v1alpha1_configuration_proto_depIdxs = []int32{
	2, // 0: com.wabenet.dodo.configuration.v1alpha1.ListBackdropsResponse.backdrops:type_name -> com.wabenet.dodo.core.v1alpha6.Backdrop
	...
	4, // 6: com.wabenet.dodo.configuration.v1alpha1.Plugin.GetPluginInfo:output_type -> com.wabenet.dodo.core.v1alpha6.PluginInfo
	5, // 7: com.wabenet.dodo.configuration.v1alpha1.Plugin.InitPlugin:output_type -> com.wabenet.dodo.core.v1alpha6.InitPluginResponse
	...
	2, // 10: com.wabenet.dodo.configuration.v1alpha1.Plugin.GetBackdrop:output_type -> com.wabenet.dodo.core.v1alpha6.Backdrop
...
type PluginClient interface {
	...
	GetBackdrop(ctx context.Context, in *GetBackdropRequest, opts ...grpc.CallOption) (*v1alpha6.Backdrop, error)
}
...
func (c *pluginClient) GetBackdrop(ctx context.Context, in *GetBackdropRequest, opts ...grpc.CallOption) (*v1alpha6.Backdrop, error) {
	out := new(v1alpha6.Backdrop)
...
type PluginServer interface {
	...
	GetBackdrop(context.Context, *GetBackdropRequest) (*v1alpha6.Backdrop, error)
}
...
func (*UnimplementedPluginServer) GetBackdrop(context.Context, *GetBackdropRequest) (*v1alpha6.Backdrop, error) {

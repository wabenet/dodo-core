...
type CreateImageRequest struct {
	...
	Config   *BuildInfo `protobuf:"bytes,2,opt,name=config,proto3" json:"config,omitempty"`
...
var file_api_v1alpha4_builder_proto_rawDesc = []byte{
	...
	0x61, 0x34, 0x2f, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa2,
	...
	0x49, 0x64, 0x12, 0x41, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x02, 0x20, 0x01,
	...
	0x68, 0x61, 0x34, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18,
	...
	0x64, 0x74, 0x68, 0x22, 0x30, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x6d, 0x61,
	...
	0x61, 0x67, 0x65, 0x49, 0x64, 0x32, 0xe8, 0x03, 0x0a, 0x0d, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65,
	0x72, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x12, 0x53, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x50, 0x6c,
	...
	0x34, 0x2e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x58, 0x0a, 0x0a,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x71, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4f,
	...
	0x75, 0x74, 0x44, 0x61, 0x74, 0x61, 0x30, 0x01, 0x12, 0x76, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x32, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x77, 0x61,
	0x62, 0x65, 0x6e, 0x65, 0x74, 0x2e, 0x64, 0x6f, 0x64, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x34, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49,
	0x6d, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x33, 0x2e, 0x63, 0x6f,
	0x6d, 0x2e, 0x77, 0x61, 0x62, 0x65, 0x6e, 0x65, 0x74, 0x2e, 0x64, 0x6f, 0x64, 0x6f, 0x2e, 0x63,
	0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x34, 0x2e, 0x43, 0x72, 0x65,
...
var file_api_v1alpha4_builder_proto_goTypes = []interface{}{
	...
	(*StreamOutputRequest)(nil), // 4: com.wabenet.dodo.core.v1alpha4.StreamOutputRequest
	(*PluginInfo)(nil),          // 5: com.wabenet.dodo.core.v1alpha4.PluginInfo
	(*InitPluginResponse)(nil),  // 6: com.wabenet.dodo.core.v1alpha4.InitPluginResponse
	(*OutputData)(nil),          // 7: com.wabenet.dodo.core.v1alpha4.OutputData
}
var file_api_v1alpha4_builder_proto_depIdxs = []int32{
	...
	4, // 4: com.wabenet.dodo.core.v1alpha4.BuilderPlugin.StreamOutput:input_type -> com.wabenet.dodo.core.v1alpha4.StreamOutputRequest
	...
	5, // 6: com.wabenet.dodo.core.v1alpha4.BuilderPlugin.GetPluginInfo:output_type -> com.wabenet.dodo.core.v1alpha4.PluginInfo
	6, // 7: com.wabenet.dodo.core.v1alpha4.BuilderPlugin.InitPlugin:output_type -> com.wabenet.dodo.core.v1alpha4.InitPluginResponse
	3, // 8: com.wabenet.dodo.core.v1alpha4.BuilderPlugin.ResetPlugin:output_type -> google.protobuf.Empty
	7, // 9: com.wabenet.dodo.core.v1alpha4.BuilderPlugin.StreamOutput:output_type -> com.wabenet.dodo.core.v1alpha4.OutputData
...
type BuilderPluginClient interface {
	...
	StreamOutput(ctx context.Context, in *StreamOutputRequest, opts ...grpc.CallOption) (BuilderPlugin_StreamOutputClient, error)
...
func (c *builderPluginClient) StreamOutput(ctx context.Context, in *StreamOutputRequest, opts ...grpc.CallOption) (BuilderPlugin_StreamOutputClient, error) {
	stream, err := c.cc.NewStream(ctx, &_BuilderPlugin_serviceDesc.Streams[0], "/com.wabenet.dodo.core.v1alpha4.BuilderPlugin/StreamOutput", opts...)
	if err != nil {
		return nil, err
	}
	x := &builderPluginStreamOutputClient{stream}
...
type BuilderPlugin_StreamOutputClient interface {
	Recv() (*OutputData, error)
	grpc.ClientStream
}

type builderPluginStreamOutputClient struct {
	grpc.ClientStream
}

func (x *builderPluginStreamOutputClient) Recv() (*OutputData, error) {
	m := new(OutputData)
...
type BuilderPluginServer interface {
	...
	StreamOutput(*StreamOutputRequest, BuilderPlugin_StreamOutputServer) error
...
func (*UnimplementedBuilderPluginServer) StreamOutput(*StreamOutputRequest, BuilderPlugin_StreamOutputServer) error {
...
func _BuilderPlugin_StreamOutput_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StreamOutputRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BuilderPluginServer).StreamOutput(m, &builderPluginStreamOutputServer{stream})
}

type BuilderPlugin_StreamOutputServer interface {
	Send(*OutputData) error
	grpc.ServerStream
}

type builderPluginStreamOutputServer struct {
	grpc.ServerStream
}

func (x *builderPluginStreamOutputServer) Send(m *OutputData) error {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _BuilderPlugin_StreamOutput_Handler,
			ServerStreams: true,
		},
	},

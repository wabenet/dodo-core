...
// 	protoc        v3.12.4
// source: api/v1alpha4/plugin.proto
...
func (OutputData_Channel) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1alpha4_plugin_proto_enumTypes[0].Descriptor()
}

func (OutputData_Channel) Type() protoreflect.EnumType {
	return &file_api_v1alpha4_plugin_proto_enumTypes[0]
}
...
func (OutputData_Channel) EnumDescriptor() ([]byte, []int) {
	return file_api_v1alpha4_plugin_proto_rawDescGZIP(), []int{4, 0}
}
...
func (x *PluginName) Reset() {
	*x = PluginName{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v1alpha4_plugin_proto_msgTypes[0]
...
func (*PluginName) Descriptor() ([]byte, []int) {
	return file_api_v1alpha4_plugin_proto_rawDescGZIP(), []int{0}
}
...
func (x *PluginInfo) Reset() {
	*x = PluginInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v1alpha4_plugin_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PluginInfo) Descriptor() ([]byte, []int) {
	return file_api_v1alpha4_plugin_proto_rawDescGZIP(), []int{1}
}
...
func (x *InitPluginResponse) Reset() {
	*x = InitPluginResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v1alpha4_plugin_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InitPluginResponse) Descriptor() ([]byte, []int) {
	return file_api_v1alpha4_plugin_proto_rawDescGZIP(), []int{2}
}
...
func (x *InputData) Reset() {
	*x = InputData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v1alpha4_plugin_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InputData) Descriptor() ([]byte, []int) {
	return file_api_v1alpha4_plugin_proto_rawDescGZIP(), []int{3}
}
...
type OutputData struct {
	...
	Channel OutputData_Channel `protobuf:"varint,1,opt,name=channel,proto3,enum=com.wabenet.dodo.core.v1alpha4.OutputData_Channel" json:"channel,omitempty"`
...
func (x *OutputData) Reset() {
	*x = OutputData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v1alpha4_plugin_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OutputData) Descriptor() ([]byte, []int) {
	return file_api_v1alpha4_plugin_proto_rawDescGZIP(), []int{4}
}
...
func (x *StreamInputRequest) Reset() {
	*x = StreamInputRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v1alpha4_plugin_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamInputRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha4_plugin_proto_rawDescGZIP(), []int{5}
}
...
func (x *InitialStreamInputRequest) Reset() {
	*x = InitialStreamInputRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v1alpha4_plugin_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InitialStreamInputRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha4_plugin_proto_rawDescGZIP(), []int{6}
}
...
func (x *StreamOutputRequest) Reset() {
	*x = StreamOutputRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v1alpha4_plugin_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamOutputRequest) Descriptor() ([]byte, []int) {
	return file_api_v1alpha4_plugin_proto_rawDescGZIP(), []int{7}
}
...
var File_api_v1alpha4_plugin_proto protoreflect.FileDescriptor

var file_api_v1alpha4_plugin_proto_rawDesc = []byte{
	0x0a, 0x19, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x34, 0x2f, 0x70,
	...
	0x72, 0x65, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x34, 0x22, 0x34, 0x0a, 0x0a, 0x50,
	...
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x34, 0x2e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x4e, 0x61,
	...
	0x34, 0x2e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x46, 0x69, 0x65,
	...
	0x68, 0x61, 0x34, 0x2e, 0x49, 0x6e, 0x69, 0x74, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x52, 0x65,
	...
	0x65, 0x6e, 0x65, 0x74, 0x2e, 0x64, 0x6f, 0x64, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76,
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x34, 0x2e, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x44, 0x61,
	...
	0x54, 0x44, 0x45, 0x52, 0x52, 0x10, 0x02, 0x22, 0xdc, 0x01, 0x0a, 0x12, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x64,
	0x0a, 0x0f, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x77, 0x61,
	0x62, 0x65, 0x6e, 0x65, 0x74, 0x2e, 0x64, 0x6f, 0x64, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x34, 0x2e, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c,
	...
	,
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x61, 0x62, 0x65, 0x6e, 0x65, 0x74,
	0x2f, 0x64, 0x6f, 0x64, 0x6f, 0x2d, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76,
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x34, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_api_v1alpha4_plugin_proto_rawDescOnce sync.Once
	file_api_v1alpha4_plugin_proto_rawDescData = file_api_v1alpha4_plugin_proto_rawDesc
)

func file_api_v1alpha4_plugin_proto_rawDescGZIP() []byte {
	file_api_v1alpha4_plugin_proto_rawDescOnce.Do(func() {
		file_api_v1alpha4_plugin_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_v1alpha4_plugin_proto_rawDescData)
	})
	return file_api_v1alpha4_plugin_proto_rawDescData
}

var file_api_v1alpha4_plugin_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_api_v1alpha4_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_api_v1alpha4_plugin_proto_goTypes = []interface{}{
	(OutputData_Channel)(0),           // 0: com.wabenet.dodo.core.v1alpha4.OutputData.Channel
	(*PluginName)(nil),                // 1: com.wabenet.dodo.core.v1alpha4.PluginName
	(*PluginInfo)(nil),                // 2: com.wabenet.dodo.core.v1alpha4.PluginInfo
	(*InitPluginResponse)(nil),        // 3: com.wabenet.dodo.core.v1alpha4.InitPluginResponse
	(*InputData)(nil),                 // 4: com.wabenet.dodo.core.v1alpha4.InputData
	(*OutputData)(nil),                // 5: com.wabenet.dodo.core.v1alpha4.OutputData
	(*StreamInputRequest)(nil),        // 6: com.wabenet.dodo.core.v1alpha4.StreamInputRequest
	(*InitialStreamInputRequest)(nil), // 7: com.wabenet.dodo.core.v1alpha4.InitialStreamInputRequest
	(*StreamOutputRequest)(nil),       // 8: com.wabenet.dodo.core.v1alpha4.StreamOutputRequest
	nil,                               // 9: com.wabenet.dodo.core.v1alpha4.PluginInfo.FieldsEntry
	nil,                               // 10: com.wabenet.dodo.core.v1alpha4.InitPluginResponse.ConfigEntry
}
var file_api_v1alpha4_plugin_proto_depIdxs = []int32{
	1,  // 0: com.wabenet.dodo.core.v1alpha4.PluginInfo.name:type_name -> com.wabenet.dodo.core.v1alpha4.PluginName
	1,  // 1: com.wabenet.dodo.core.v1alpha4.PluginInfo.dependencies:type_name -> com.wabenet.dodo.core.v1alpha4.PluginName
	9,  // 2: com.wabenet.dodo.core.v1alpha4.PluginInfo.fields:type_name -> com.wabenet.dodo.core.v1alpha4.PluginInfo.FieldsEntry
	10, // 3: com.wabenet.dodo.core.v1alpha4.InitPluginResponse.config:type_name -> com.wabenet.dodo.core.v1alpha4.InitPluginResponse.ConfigEntry
	0,  // 4: com.wabenet.dodo.core.v1alpha4.OutputData.channel:type_name -> com.wabenet.dodo.core.v1alpha4.OutputData.Channel
	7,  // 5: com.wabenet.dodo.core.v1alpha4.StreamInputRequest.initial_request:type_name -> com.wabenet.dodo.core.v1alpha4.InitialStreamInputRequest
	4,  // 6: com.wabenet.dodo.core.v1alpha4.StreamInputRequest.input_data:type_name -> com.wabenet.dodo.core.v1alpha4.InputData
...
func init() { file_api_v1alpha4_plugin_proto_init() }
func file_api_v1alpha4_plugin_proto_init() {
	if File_api_v1alpha4_plugin_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_v1alpha4_plugin_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha4_plugin_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha4_plugin_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha4_plugin_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha4_plugin_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha4_plugin_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha4_plugin_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha4_plugin_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_v1alpha4_plugin_proto_msgTypes[5].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_v1alpha4_plugin_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_v1alpha4_plugin_proto_goTypes,
		DependencyIndexes: file_api_v1alpha4_plugin_proto_depIdxs,
		EnumInfos:         file_api_v1alpha4_plugin_proto_enumTypes,
		MessageInfos:      file_api_v1alpha4_plugin_proto_msgTypes,
	}.Build()
	File_api_v1alpha4_plugin_proto = out.File
	file_api_v1alpha4_plugin_proto_rawDesc = nil
	file_api_v1alpha4_plugin_proto_goTypes = nil
	file_api_v1alpha4_plugin_proto_depIdxs = nil
}

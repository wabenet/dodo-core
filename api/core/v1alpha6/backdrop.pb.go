...
type Backdrop struct {
	...
	Files         []*FileUpload          `protobuf:"bytes,11,rep,name=files,proto3" json:"files,omitempty"`
...
func (x *Backdrop) GetFiles() []*FileUpload {
	if x != nil {
		return x.Files
	}
	return nil
...
func (x *FileUpload) GetContents() string {
	if x != nil {
		return x.Contents
	}
	return ""
...
var file_core_v1alpha6_backdrop_proto_rawDesc = []byte{
	...
	0x0e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x44, 0x69,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x68, 0x6f, 0x73, 0x74, 0x49, 0x70, 0x22, 0x3c, 0x0a,

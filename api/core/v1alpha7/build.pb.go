...
// 	protoc        v3.21.12
// source: core/v1alpha7/build.proto
...
func (x *BuildInfo) Reset() {
	*x = BuildInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_v1alpha7_build_proto_msgTypes[0]
...
func (*BuildInfo) Descriptor() ([]byte, []int) {
	return file_core_v1alpha7_build_proto_rawDescGZIP(), []int{0}
}
...
func (x *BuildArgument) Reset() {
	*x = BuildArgument{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_v1alpha7_build_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BuildArgument) Descriptor() ([]byte, []int) {
	return file_core_v1alpha7_build_proto_rawDescGZIP(), []int{1}
}
...
func (x *BuildSecret) Reset() {
	*x = BuildSecret{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_v1alpha7_build_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BuildSecret) Descriptor() ([]byte, []int) {
	return file_core_v1alpha7_build_proto_rawDescGZIP(), []int{2}
}
...
func (x *SshAgent) Reset() {
	*x = SshAgent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_v1alpha7_build_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SshAgent) Descriptor() ([]byte, []int) {
	return file_core_v1alpha7_build_proto_rawDescGZIP(), []int{3}
}
...
var File_core_v1alpha7_build_proto protoreflect.FileDescriptor

var file_core_v1alpha7_build_proto_rawDesc = []byte{
	0x0a, 0x19, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x37, 0x2f,
	...
	0x72, 0x65, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x37, 0x22, 0x8b, 0x04, 0x0a, 0x09,
	...
	0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x37, 0x2e, 0x42, 0x75,
	...
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x37, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x53, 0x65,
	...
	0x61, 0x37, 0x2e, 0x53, 0x73, 0x68, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x09, 0x73, 0x73, 0x68,
	...
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x37, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_core_v1alpha7_build_proto_rawDescOnce sync.Once
	file_core_v1alpha7_build_proto_rawDescData = file_core_v1alpha7_build_proto_rawDesc
)

func file_core_v1alpha7_build_proto_rawDescGZIP() []byte {
	file_core_v1alpha7_build_proto_rawDescOnce.Do(func() {
		file_core_v1alpha7_build_proto_rawDescData = protoimpl.X.CompressGZIP(file_core_v1alpha7_build_proto_rawDescData)
	})
	return file_core_v1alpha7_build_proto_rawDescData
}

var file_core_v1alpha7_build_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_core_v1alpha7_build_proto_goTypes = []interface{}{
	(*BuildInfo)(nil),     // 0: com.wabenet.dodo.core.v1alpha7.BuildInfo
	(*BuildArgument)(nil), // 1: com.wabenet.dodo.core.v1alpha7.BuildArgument
	(*BuildSecret)(nil),   // 2: com.wabenet.dodo.core.v1alpha7.BuildSecret
	(*SshAgent)(nil),      // 3: com.wabenet.dodo.core.v1alpha7.SshAgent
}
var file_core_v1alpha7_build_proto_depIdxs = []int32{
	1, // 0: com.wabenet.dodo.core.v1alpha7.BuildInfo.arguments:type_name -> com.wabenet.dodo.core.v1alpha7.BuildArgument
	2, // 1: com.wabenet.dodo.core.v1alpha7.BuildInfo.secrets:type_name -> com.wabenet.dodo.core.v1alpha7.BuildSecret
	3, // 2: com.wabenet.dodo.core.v1alpha7.BuildInfo.ssh_agents:type_name -> com.wabenet.dodo.core.v1alpha7.SshAgent
...
func init() { file_core_v1alpha7_build_proto_init() }
func file_core_v1alpha7_build_proto_init() {
	if File_core_v1alpha7_build_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_core_v1alpha7_build_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_v1alpha7_build_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_v1alpha7_build_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_v1alpha7_build_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_core_v1alpha7_build_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_core_v1alpha7_build_proto_goTypes,
		DependencyIndexes: file_core_v1alpha7_build_proto_depIdxs,
		MessageInfos:      file_core_v1alpha7_build_proto_msgTypes,
	}.Build()
	File_core_v1alpha7_build_proto = out.File
	file_core_v1alpha7_build_proto_rawDesc = nil
	file_core_v1alpha7_build_proto_goTypes = nil
	file_core_v1alpha7_build_proto_depIdxs = nil
}
